...
{
    public static $fixture_file = 'sapphire/tests/DataObjectDecoratorTest.yml';
    ...
    public function testOneToManyAssociationWithDecorator()
    {
    ...
    public function testManyManyAssociationWithDecorator()
    {
     ...
     */
    public function testApiAccessCanBeDecorated()
    {
        $this->assertTrue(Object::get_static('DataObjectDecoratorTest_Member', 'api_access'));
    }
    
    public function testPermissionDecoration()
    {
     ...
     */
    public function testDbObjectOnDecoratedFields()
    {
    ...
    public function testDecoratorCanBeAppliedToDataObject()
    {
        $do = new DataObject();
