...
class TranslatableTest extends FunctionalTest
{
    ...
    public static $fixture_file = 'sapphire/tests/model/TranslatableTest.yml';
    ...
    public function testLocalePersistsInAllPageTypes()
    {
        $types = ClassInfo::subclassesFor('SiteTree');
        foreach ($types as $type) {
            if (singleton($type) instanceof TestOnly) {
                continue;
            }
