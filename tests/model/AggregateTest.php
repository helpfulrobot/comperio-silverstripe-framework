...
class AggregateTest_Foo extends DataObject implements TestOnly
{
    ...
    public static $has_one = array('Bar' => 'AggregateTest_Bar');
    public static $belongs_many_many = array('Bazi' => 'AggregateTest_Baz');
}
...
{
    public static $fixture_file = 'sapphire/tests/model/AggregateTest.yml';
