...
class ArrayDataTest extends SapphireTest
{
    ...
    public function testWrappingAnEmptyObjectWorks()
    {
        $object = (object) array();
        $this->assertTrue(is_object($object));
    ...
    public function testWrappingAnEmptyArrayWorks()
    {
        $arrayData = new ArrayData(array());
    ...
    public function testForTemplateWorks()
    {
        $arrayData = new ArrayData(array('b' => 'bunny'));
        $this->assertEquals("array (\n  'b' => 'bunny',\n)", $arrayData->forTemplate());
    }

    public function testObjectToArrayWorks()
    {
        $object = new ArrayDataTest_NonEmptyObject();
