...
class ObjectTest_MyObject extends Object
{
    ...
    public static $mystaticProperty = "MyObject";
    public static $mystaticArray = array('one');
}

class ObjectTest_MySubObject extends ObjectTest_MyObject
{
    public $title = 'my subobject';
    public static $mystaticProperty = "MySubObject";
    public static $mystaticSubProperty = "MySubObject";
    public static $mystaticArray = array('two');
}
