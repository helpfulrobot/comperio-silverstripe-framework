...
class PasswordEncryptorTest extends SapphireTest
{
    ...
    public function testEncrytorPHPHashWithArguments()
    {
    ...
    public function testEncrytorPHPHash()
    {
    ...
    public function testEncrytorPHPHashCompare()
    {
        PasswordEncryptor::register('test_sha1', 'PasswordEncryptor_PHPHash("sha1")');
        $e = PasswordEncryptor::create_for_algorithm('test_sha1');
     ...
     */
    public function testEncrytorLegacyPHPHashCompare()
    {
