...
class ManifestBuilderTest extends SapphireTest
{
    ...
    public function testManifestIgnoresClassesInComments()
    {
        $baseFolder = TEMP_FOLDER . '/manifest-test-asdfasdfasdf';
        global $project;
    ...
    public function testManifestIgnoresClassesInStrings()
    {
        $baseFolder = TEMP_FOLDER . '/manifest-test-asdfasdfasdf';
        $manifestInfo = ManifestBuilder::get_manifest_info($baseFolder);
    ...
    public function testClassNamesDontHaveToBeTheSameAsFileNames()
    {
        $baseFolder = TEMP_FOLDER . '/manifest-test-asdfasdfasdf';
        $manifestInfo = ManifestBuilder::get_manifest_info($baseFolder);
    ...
    public function setUp()
    {
        ...
        // $project value.
        if (self::$test_fixture_project) {
            $project = self::$test_fixture_project;
        }
    ...
    public function tearDown()
    {
        ...
        if (!self::$test_fixture_project) {
            self::$test_fixture_project = $project;
        }
